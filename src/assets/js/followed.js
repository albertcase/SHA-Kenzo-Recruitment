...
;(function(){
    ...
    controller.prototype.startUp = function(){
        ...
        if(self.user.isOld && self.user.isLuckyDraw && self.user.isSubmit){
            ...
            $('.product-name-2').removeClass('hide');
    ...
    controller.prototype.bindEvent = function(){
        ...
        $('.terms-link').on('touchstart',function(){
            ...
            var termContent = [
                ...
                {
                    time:'2017年8月9日至2017年8月13日',
                    condition:'活动期间，关注KenzoParfums凯卓官方微信的用户将活动分享给好友，即可参与抽奖（随机抽取）。每个微信ID仅限中将一次，奖品限量100分。中奖名单将于活动结束后公布。',
